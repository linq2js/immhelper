...
(function() {
  ...
  var _addResult = function(results, condition) {
    return results.push(
      condition ? chalk.green.bold("P") : chalk.green.red("F")
    );
  };
  ...
  var _verify = function(solution) {
    ...
    (init = solution.init),
      (get = solution.get),
      (set = solution.set),
      (setDeep = solution.setDeep),
      (getIn = solution.getIn),
      (setIn = solution.setIn),
      (merge = solution.merge),
      (initArr = solution.initArr),
      (getAt = solution.getAt),
      (setAt = solution.setAt);
